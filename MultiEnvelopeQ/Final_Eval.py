...
class PopArtMORL:
        ...
        for episode in pbar:
            ...
            if len(batch_datas['states']) > Config.BATCH_SIZE: ### if update then begin update ###
                ...
                if len(infos) % 50 == 0:
                    ...
                    torch.save(self.net, 'models/EnvMo.pkl')
    ...
    def comprehensive_eval(self, path):
        ...
        np.savetxt('res/PopArt_good'+path[-5] + '.txt', np.array(compare_datas), fmt='%.3f')
...
if __name__ == '__main__':
    ...
    popArtMorl.eval('models/PopArtEnvMoFianl.pkl')
    # popArtMorl.comprehensive_eval('models/PopArtEnvMo_good2.pkl')
