...
class MORL:
    ...
    def __init__(self, load_path = None):
        ...
        self.net_optimizer = torch.optim.SGD(self.net.parameters(), lr=Config.LEARNING_RATE)
    ...
    def eval(self, path):
        ...
        while not done:
            action = self.get_action(state, cur_preferences, False)
...
if __name__ == '__main__':
    ...
    morl = MORL(load_path='models/EnvMo_day3_good2.pkl')
